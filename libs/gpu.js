	...
	1: [function (require, module, exports) {
		...
		(function (global, factory) {
			...
			pp$1.isAsyncFunction = function () {
				if (this.type !== types.name || this.options.ecmaVersion < 8 || this.value != "async") { return false }
			...
			pp$1.parseFunction = function (node, isStatement, allowExpressionBody, isAsync) {
				...
				if (this.options.ecmaVersion >= 6 && !isAsync) { node.generator = this.eat(types.star); }
				...
				while (!this.eat(types.braceR)) {
					...
					if (isGetSet) {
						...
						if (method.value.params.length !== paramCount) {
							...
							if (method.kind === "get") { this$1.raiseRecoverable(start, "getter should have no params"); }
							else { this$1.raiseRecoverable(start, "setter should have exactly one param"); }
						} else {
			...
			pp$3.parseExprAtom = function (refDestructuringErrors) {
				...
				switch (this.type) {
					...
					case types.name:
						...
						if (this.options.ecmaVersion >= 8 && id.name === "async" && !this.canInsertSemicolon() && this.eat(types._function)) { return this.parseFunction(this.startNodeAt(startPos, startLoc), false, false, true) }
